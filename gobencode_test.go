...
func TestParseFromReaderBasic(t *testing.T) {
	...
	for _, test := range tests {
		output, err := ParseFromReader(strings.NewReader(test.input))
...
func TestParseFromReaderBasicString(t *testing.T) {
	tests := []struct {
		input    string
		expected interface{}
	}{
...
func TestParseFromReaderBasicInteger(t *testing.T) {
	tests := []struct {
		input    string
		expected interface{}
	}{
...
func TestParseFromReaderBasicList(t *testing.T) {
	tests := []struct {
		input    string
		expected interface{}
	}{
...
func TestParseFromReaderBasicDictionary(t *testing.T) {
	tests := []struct {
		input    string
		expected interface{}
	}{
...
func TestParseFromReaderBasicTorrent(t *testing.T) {
	tests := []string{
	...
	for index, test := range tests {
		...
		_, err := ParseFromReader(strings.NewReader(test))
